...
<div class="flex justify-center items-center w-full min-h-screen p-8">
    ...
    <div class="flex flex-col items-center mr-8">
        <div class="relative w-28 h-28 rounded-full overflow-hidden cursor-pointer">
            <a href="/edit/avatar">
                <img src={image_path} alt="Profile Picture" class="w-full h-full object-cover" title="Change Avatar"/>
            </a>
        </div>
    </div>
    ...
    <div class="flex flex-col">
        ...
        <div class="grid grid-cols-2 gap-5">
            ...
            <a href="/edit/interests" class="btn btn-outline btn-primary">Interests</a>
            <a href="/edit/availabilities" class="btn btn-outline btn-primary">Availabilities</a>
            <a href="/edit/password" class="btn btn-outline btn-primary">Password</a>
        </div>
    </div>
</div>
